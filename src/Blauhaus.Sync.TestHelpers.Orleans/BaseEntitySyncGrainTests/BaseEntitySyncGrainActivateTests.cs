...
{
    public abstract class BaseEntitySyncGrainActivateTests<TDbContext, TGrain, TEntity, TEntityBuilder, TGrainResolver, TDto, TSyncGrain> 
        : BaseEntityGrainActivateTests<TDbContext, TGrain, TEntity, TEntityBuilder, TGrainResolver, TDto>
        where TGrain: BaseEntitySyncGrain<TDbContext, TEntity, TDto, TSyncGrain, TGrainResolver>, IVoidAuthenticatedCommandHandler<ActivateCommand, IAuthenticatedUser> 
        ...
        where TGrainResolver : class, IGrainResolver
    {
        ...
        public async Task WHEN_activated_SHOULD_publish_Dto(EntityState validState)
        {
            //Arrange
            ...
            //Assert 
            MockDtoSyncGrain.Verify(x => x.UpdateDtoAsync(It.Is<TDto>(y =>
                y.Id == GrainId &&
                y.EntityState == EntityState.Active)));
        }
    }
}